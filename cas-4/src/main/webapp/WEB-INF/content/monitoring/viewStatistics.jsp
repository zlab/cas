<%@include file="../default/ui/includes/top.jsp"%>
...
<table width="800">
    ...
    <tbody>
        ...
        <tr>
            <td>Memory</td>
            <td>${freeMemory} MB free <img src="images/green.gif" width="${freeMemory / (totalMemory) * 500}"
                height="30" /><img src="images/red.gif" width="${(totalMemory - freeMemory) / totalMemory * 500}"
...
<%@include file="../default/ui/includes/bottom.jsp"%>